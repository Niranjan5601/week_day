            ...
            <CardContent>
                <Box sx={{ display: 'flex', gap:'0.5rem', }}>
                    <Box component={"img"} sx={{
                        height: '2.5rem',
                    }} alt="logo" src="https://logo.clearbit.com/dropbox.com"></Box>
                    <div>
                        <div className="info-container">
                            <Box component={'h3'}>Granicus</Box>
                            <h2>Systems Engineer III - Linux</h2>
                        </div>
                        <p className="cards-sub-text">Bengaluru</p>
                    </div>
